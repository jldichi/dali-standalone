...
*
* $Id: b.cc,v 1.1.1.1 1996/04/16 18:52:47 gustavof Exp $
*
...
ixBool TextCursor::insChar(char c)
{
	idCheck();

	ixBool res = ListCursor(String)::value().insChar(c, ncol);
...
ixBool TextCursor::delChar()
{
	idCheck();

	ixBool res = ListCursor(String)::value().delChar(ncol);
...
void TextCursor::moveCol(Int i, ixBool cursMove)
{
	idCheck();
