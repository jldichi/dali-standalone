...
*
* $Id: isoftdbes.h,v 1.6 2002/05/08 20:13:51 hardaiz Exp $
* DESCRIPTION:
*
********************************************************************/
#ifndef ISOFTDBES_H
...
class IsoftDbEs : public IsoftDb {
...
//virtual inline sqlcursor CreateSQLCursor(schema sch, char *sentence, int paramsCount);
virtual inline sqlcursor CreateSQLCursor(schema sch, const char *sentence, int paramsCount);
//virtual inline sqlcursor CreateSQLCursor(char *sentence, int paramsCount, va_list av);
//virtual inline sqlcursor CreateSQLCursor(const char *sentence, int paramsCount, va_list av);
...
#include <ideafix/priv/isoftdbes.icc>
#endif
