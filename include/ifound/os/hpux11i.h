...
#define _OS_SHORT_NAME_	"hpux11i"
...
//#define HAVE_TGETENT_DIFFERENT_RETURN_VALUE 1
...
#define BCOPYPARAM3TYPE			SizeT  //long unsigned int
#define	BZEROPARAM2TYPE			SizeT  //int
...
#define GETHOSTNPARAM2TYPE		long unsigned int
//ANTES
...
//ANTES
#define MSGRCVPARAM2TYPE		void *
#define MSGRCVPARAM3TYPE		long unsigned int
#define MSGSNDPARAM2TYPE		const void *
#define MSGSNDPARAM3TYPE		long unsigned int
...
//ANTES
#define QSORTPARAM2TYPE			long unsigned
#define QSORTPARAM3TYPE			long unsigned
...
#define READPARAM3TYPE			long unsigned
//ANTES
...
#define SEMOPPARAM3TYPE			long unsigned
//ANTES
...
#define WRITEPARAM3TYPE			long unsigned
//ANTES
...
#define CFIX_DEBUG			" -g "
#define CFIX_LINK			"cc "
#define CFIX_LINK_ORA		"cc "
#define CFIX_LINK_IFX		"esql "
#define CFIX_LIBDIRSFLAG	" -L"
#define CFIX_LIBDIR		"/lib "
#define CFIX_SHLIBDIR		" "
#define CFIX_LINKSTRIP		" -s "
#define CFIX_LINKDEBUG		" -g "
#define CFIX_OUTFILE		"-o "

#define CFIX_IXDBLIB            " -ldb -lix -les -lsql -lsqlimpl -lidea -liext -ldb -lix -les -lsql -lsqlimpl -lidea -liext "
#define CFIX_ESDBLIB            " -ldb -lix -les -lsql -lsqlimpl -lidea -liext -ldb -lix -les -lsql -lsqlimpl -lidea -liext "
#define CFIX_SQLFWDBLIB         " -ldb -lix -les -lsql -lsqlimpl -lidea -liext -ldb -lix -les -lsql -lsqlimpl -lidea -liext "
#define CFIX_SCKTLIB            ""
#define CFIX_IDEALIB            " -lidea -liext -lidea -liext -lm "
#define CFIX_IXDBSHLIB          " -L/SH521 -ldb521_s -lix521_s -les521_s -lsql521_s -lsqlimpl521_s -lidea521_s -liext521_s "
#define CFIX_ESDBSHLIB          " -L/SH521 -ldb521_s -lix521_s -les521_s -lsql521_s -lsqlimpl521_s -lidea521_s -liext521_s "
#define CFIX_SQLFWSHLIB         " -L/SH521 -ldb521_s -lix521_s -les521_s -lsql521_s -lsqlimpl521_s -lidea521_s -liext521_s "
#define CFIX_SCKTSHLIB          ""
#define CFIX_IDEASHLIB          " -lidea521_s -liext521_s -lm "
