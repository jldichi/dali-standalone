...
*
* $Id: linux6.h,v 1.11 2008/06/02 19:29:39 spark Exp $
*
* DESCRIPTION
...
// Este define muestra la version de kernal
#define _OSVER_	UTS_RELEASE 

#define _OS_SHORT_NAME_	"linux6"
#define _OS_	"Linux"
...
#define LISTENPARAM2TYPE                unsigned int
...
#define CFIX_COMPILER		"egcs -c "
#define CFIX_OPTIM			" -O0 "
#define CFIX_DEBUG			" -g "
#define CFIX_LINK			" egcs "
#define CFIX_LINK_IFX			" esql "
#define CFIX_LINK_ORA			" egcs "
#define CFIX_LIBDIRSFLAG	" -L"
#define CFIX_LIBDIR			"/lib "
#define CFIX_SHLIBDIR		"-L/SH521 -L$IDEAFIX/lib"
#define CFIX_LINKSTRIP		" -s "
#define CFIX_LINKDEBUG		" -g "
#define CFIX_OUTFILE		"-o "
#define CFIX_IXDBLIB		" -ldb -lix -les -lsql -lsqlimpl -ldb -lix -les -lsql -lsqlimpl -ldb "
#define CFIX_ESDBLIB		" -ldb -lix -les -lsql -lsqlimpl -ldb -lix -les -lsql -lsqlimpl -ldb "
#define CFIX_SQLFWDBLIB		" -ldb -lix -les -lsql -lsqlimpl -ldb -lix -les -lsql -lsqlimpl -ldb "
#define CFIX_SCKTLIB		" "
#define CFIX_IDEALIB		" -liext -lidea -liext -lidea -lm "
#define CFIX_IXDBSHLIB		" -ldb521_s -lix521_s -les521_s -lsql521_s -lsqlimpl521_s "
#define CFIX_ESDBSHLIB		" -ldb521_s -lix521_s -les521_s -lsql521_s -lsqlimpl521_s "
#define CFIX_SQLFWSHLIB		" -ldb521_s -lix521_s -les521_s -lsql521_s -lsqlimpl521_s "
