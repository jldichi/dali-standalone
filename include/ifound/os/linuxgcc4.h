...
#define _OS_	"LinuxGcc4"
#define _OS_SHORT_NAME_	"linuxgcc4"
#define _OSVER_	"CentOS-7-x64"			// Completar con una descrip. del S.O. y kernel
...
#define CFIX_IXDBLIB_INA        " -lixsca -ldb -lix -lsql -lpq "
#define CFIX_ESDBLIB_INA        " -lixsca -ldb -lix -lsql -lpq "
#define CFIX_SQLFWDBLIB_INA     " -lixsca -ldb -lix -lsql -lpq "
#define CFIX_IXDBSHLIB_INA      " -ldb -lix -lsql -lixsca"IDEA_VERSION_Q"_s -lpq "
