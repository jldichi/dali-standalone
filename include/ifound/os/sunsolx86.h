...
*
* $Id: sunsolx86.h,v 1.12 2007/03/30 19:01:38 hardaiz Exp $
*
* DESCRIPTION
...
#define _OSVER_	"2.7"
#define _OS_SHORT_NAME_	"sunsolx86"
...
/* Typedefs */
#define INT32BITS   long
#ifndef INT_TYPEDEF
#define INT_TYPEDEF
typedef INT32BITS Int;
typedef unsigned INT32BITS UnInt;
#endif
...
#define	CAN_HAVE_INLINE_STAT		1
#define	LINUX_STAT_VERSION		1
...
#define HAVE_SECURITY_CHECK		1
#define HAVE_SEMAPHORES			1
#define HAVE_SETPGRP_VOID			1
...
#define CFIX_IXDBLIB                    " -ldb -lix -les -lsql -lsqlimpl -liqlsrv -ldb -lix -les -lsql -lsqlimpl -ldb "
#define CFIX_ESDBLIB                    " -ldb -lix -les -lsql -lsqlimpl -liqlsrv -ldb -lix -les -lsql -lsqlimpl -ldb "
#define CFIX_SQLFWDBLIB         " -ldb -lix -les -lsql -lsqlimpl -liqlsrv -ldb -lix -les -lsql -lsqlimpl -ldb "
#define CFIX_SCKTLIB                    " "
